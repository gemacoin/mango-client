...
import { Token, u64 } from '@gemachain/spl-token';
import { Account, Connection, PublicKey, Transaction, TransactionInstruction, TransactionSignature } from '@gemachain/web3.js';
...
export declare function createTokenAccountInstrs(connection: Connection, newAccountPubkey: PublicKey, mint: PublicKey, ownerPk: PublicKey, carats?: number): Promise<TransactionInstruction[]>;
